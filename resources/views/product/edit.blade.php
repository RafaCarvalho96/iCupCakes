    ...
    <div class="container" style="margin-top: 5em;">
        <div class="card">
            <div class="card-header">
                    <h3 class="float-start">Editar Produto</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="{{route('admin.product.update',['id'=>$product->id])}}" class="form" enctype="multipart/form-data">
                    @csrf

                    <div class="row">
                        <div class="row mb-3 col-4">
                            <div class="form-group col-12">
                                <img style="width: 18rem" src="{{url('/storage/product/'.$product->id.'.'.$product->extension)}}" alt="Imagem do produto" />
                            </div>
                        </div>
                        ...
                        <div class="col-8">
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" step='0.01' value="{{$product->preco}}" placeholder='0.00' name="preco" class="form-control" id="preco">
                                </div>
                            </div>
